...
Route::post('stripe',[VisitorController::class,'stripe'])->name('stripe');
Route::post('chapa',[VisitorController::class,'chapa'])->name('chapa');
...
Route::post('/stripes',[VisitorController::class,'stripePost'])->name('stripe.post');
Route::get('/selectseat/{scheduleId}/{date}',[VisitorController::class, 'selectseat'])->name('selectseat');
